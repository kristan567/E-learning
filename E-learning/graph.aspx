...
"></asp:SqlDataSource>
            ...
            <div style="display: inline-block;">
                <div style="margin-left: 50px; display: inline-block;">
                    <asp:Chart ID="Chart3" runat="server" DataSourceID="SqlDataSource1" Width="1142px" OnLoad="Chart3_Load">
                        <Series>
                ...
                <div style="margin-left: 140px; display: inline-block;">
                    <asp:Chart ID="Chart6" runat="server" DataSourceID="SqlDataSource4" Width="1049px">
                      ...
                      <center><h3>types of kesson attended</h3></center>
